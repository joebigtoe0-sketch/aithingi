...
/* ---------------- Avatar ---------------- */
function Avatar({ agent, size = 96, frame = true, label = false }) {
  ...
  // ---------- central brain special figure ----------
  if (agent.type === "central") {
    return <CentralBrainFigure agent={agent} size={size} frame={frame} label={label} />;
  }
...
/* ============================================================
   ...
   ============================================================ */
function CentralBrainFigure({ agent, size, frame, label }) {
